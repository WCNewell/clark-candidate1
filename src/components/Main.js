    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="intro" className={`${this.props.article === 'intro' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>Post graduation studies have provided a deeper dive into React/Redux, GatsbyJS, Sass, TypeScript, and GraphQL. I am very interested in learning more about DevOps and continuous testing/deployment.</p>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <span className="image main"><img src={pic02} alt="Zenmed home page" /></span>
            < p > This app itself is designed to be a clean, uncluttered, progressive web app that is responsive to multiple media formats. App also features original logo and photography meant to represent my passion
            for the outdoors, an artistic aesthetic, and desire to achieve optimal health and positivity. <strong>Tech:</strong> Built on the "JAMstack" using GatsbyJS, featuring React, Sass, and GraphQL. Currently exploring the GraphQL functionality more while creating a headless WordPress blog section in the next iteration. Front-end deployed to Bluehost.</p >
