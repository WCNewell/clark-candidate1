    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="about" className={`${this.props.article === 'about' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>I'm looking for a supportive environment to hone my developer arts with the mentality that learning never ends.
            In turn, I bring my unique set of past experiences and skills to your team and would love to begin my developer career as a Software Engineer.</p>
          <p> When not coding, I thoroughly enjoy the outdoors, biking, working out, pets, playing the piano, and pop culture. I am proud to have been involved in the Denver area tech community as an active Co-organizer for a meetup group. I've recently returned to my roots in Utah and look forward to bringing these experiences to the Silicon Slopes where I am a regular attendee at <strong><a href='https://utahjs.com'>UtahJS</a></strong> events.</p>
