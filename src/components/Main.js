    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="intro" className={`${this.props.article === 'intro' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>Hello world! I graduated in June 2018 from <strong><a href='https://www.galvanize.com/denver-platte'>Galvanize-Denver</a></strong>, a web development immersive program where I trained in JavaScript ES6, HTML5, CSS, Vue.js, React, React Native, Node.js, PostgreSQL, git, Visual Studio, AWS, consuming APIs, and Agile methodology. There I also gained experience with various JavaScript libraries such as Vuetify, React-table, Stripe, Chart.js, Google maps, Cypress, Knex.js, and Express.</p>
          <p>Post graduation studies have provided a deeper dive into React/Redux, GatsbyJS, and GraphQL. I am very interested in learning more about Sass, TypeScript, DevOps and continuous testing/deployment.</p>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <span className="image main"><img src={pic02} alt="Zenmed home page" /></span>
            < p > This app itself is designed to be a clean, uncluttered, progressive web app that is responsive to multiple media formats, with a mobile-first approach. App also features original logo and photography meant to represent my passion
            for the outdoors, an artistic aesthetic, and desire to achieve optimal health and positivity. < strong > Tech: </strong>Built on the "JAMstack" using GatsbyJS, featuring React, Sass, and GraphQL. SEO is employed via react-helmet and site metadata configurations. Currently exploring the GraphQL functionality more while creating a headless WordPress blog section in the next iteration. Front-end deployed to Bluehost.</p >
            <p><strong><a href='https://WCNewell.github.io/max-hamburger'>BurgerBuilder</a></strong> Completed the entire Udemy React course and this is one of the resulting projects, an app that allows the user to create a login, build and order hamburger sandwiches and view all previous orders.<strong>Tech:</strong> this is a React app which employs React Router, Axios, Redux, Redux-Thunk, Redux-Saga, and Jest-testing libraries. Front-end deployed to GitHub pages, back-end hosted on Firebase.</p>
            <p><strong><a href='https://vuetiful-goals.firebaseapp.com/#/goals'>VuetifulGoals</a></strong> is a prototype goal-setting and visualization app. User goals can be added, updated or deleted. Goal form entry fields require data or give warnings. <strong>Tech:</strong> this is my first full-stack, de-coupled app featuring CRUD functionality built in Vue.js with the Vuetify library (Google Materialize bootstrap for Vue.js) on the front, and a PostgreSQL backend using the Knex.js and Express libraries. In future iterations, I would love to include user login so personal data persists and combine it with "ZenMed" as a progressive web app built in React. Front-end deployed to Firebase, back-end deployed to Heroku.</p>
            <p><strong><a href='https://zenmedvue.firebaseapp.com/#/'>ZenMed</a></strong> is a prototype meditation app featuring clean design, a music player with a soothing visualizer, a random quote generator for daily inspiration, and ZenBoard, which is a collection of white-noise buttons to bring focus while meditating. <strong>Tech:</strong> this app was designed with Vue.js and connects to the Quotes REST API. In future iterations I would love to connect to a music API, create further white-noise options featuring continuous looping of sounds and combine it with “VuetifulGoals” as a progressive web app built in React. Front-end deployed to Firebase.</p>
            <p>Please view my <strong><a href='https://github.com/WCNewell'>GitHub</a></strong> profile for more projects and futher information on the projects mentioned above.</p>
          <ul className="icons">
            <li><a href="https://twitter.com/WCNewell" className="icon fa-twitter"><span className="label">Twitter</span></a></li>
            <li><a href="https://www.linkedin.com/in/william-clark-newell/" className="icon fa-linkedin"><span className="label">LinkedIn</span></a></li>
            <li><a href="https://github.com/WCNewell" className="icon fa-github"><span className="label">GitHub</span></a></li>
        ...
        <article id="blog" className={`${this.props.article === 'blog' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>Coming next...a blog section covering my web development and fitness journies.</p>
          <p> When not coding, I thoroughly enjoy the outdoors, long distance biking, working out, pets, playing the piano, and pop culture. I am proud to have been involved in the Denver area tech community as an active Co-organizer for a monthly meetup group with 30+ attendees. I've recently returned to my roots in Utah where I am a regular attendee at <strong><a href='https://utahjs.com'>UtahJS</a></strong> events.</p>
          <p>I invite you to connect with me via the contact form or social media links.</p>
          <ul className="icons">
            <li><a href="https://twitter.com/WCNewell" className="icon fa-twitter"><span className="label">Twitter</span></a></li>
            <li><a href="https://www.linkedin.com/in/william-clark-newell/" className="icon fa-linkedin"><span className="label">LinkedIn</span></a></li>
            <li><a href="https://github.com/WCNewell" className="icon fa-github"><span className="label">GitHub</span></a></li>
