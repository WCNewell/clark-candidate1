    ...
    return (
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="intro" className={`${this.props.article === 'intro' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <p>Post graduation studies have provided a deeper dive into React/Redux, GatsbyJS, Sass, TypeScript, GraphQL, DevOps and continuous testing/deployment.</p>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <span className="image main"><img src={pic02} alt="Zenmed home page" /></span>
            ...
            <p>This app itself is designed to be clean, uncluttered, and feel like a progressive web app that is responsive to multiple media formats. <strong>Tech:</strong> I used a starter kit from GatsbyJS, featuring React and GraphQL. The gorgeous Sass is from HTML5 UP, which I modified to fit my content and personal design needs. I’m excited to explore the GraphQL functionality more while creating a blog post section in the next iteration.</p>
