      ...
      <div id="main" style={this.props.timeout ? {display: 'flex'} : {display: 'none'}}>
        ...
        <article id="work" className={`${this.props.article === 'work' ? 'active' : ''} ${this.props.articleTimeout ? 'timeout' : ''}`} style={{display:'none'}}>
          ...
          <span className="image main"><img src={pic02} alt="Zenmed home page" /></span>
            <p>This app itself is designed to be a clean, uncluttered, progressive web app that is responsive to multiple media formats. <strong>Tech:</strong> Built on the "JAMstack" I used a starter kit from GatsbyJS, featuring React, Sass, and GraphQL. Currently exploring the GraphQL functionality more while creating a headless WordPress blog section in the next iteration. Front-end deployed to BlueHost.</p>
